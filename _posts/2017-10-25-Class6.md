...
<table border='1' width='100%' id='table1'>
    ...
    input type="checkbox" name="SVet" value="吃素"> 是否吃素
select name="SDepart" >
<option value="資工系">資工系</option> 設定選擇的系
<option value="數媒系">數媒系</option> 設定選擇的系
<option value="幼教系">幼教系</option> 設定選擇的系
<option value="生醫系">生醫系</option> 設定選擇的系
</select>
    <tr>
